...
export const COOKIE_SESSAO = "nylife_painel";

const SENHA_LOCAL = process.env.PAINEL_SENHA_LOCAL ?? "nylife";
const SEGREDO = process.env.PAINEL_SEGREDO ?? "nylife-desenvolvimento";
