            ...
            >
              {imagens.map((img, i) => (
                <div
                  ...
                  className="relative aspect-square cursor-grab overflow-hidden bg-cimento-claro"
                >
                  <Image
                    src={img.url}
                    alt=""
              ...
              <label className="flex aspect-square cursor-pointer flex-col items-center justify-center gap-1 border border-dashed border-cimento-escuro text-center">
